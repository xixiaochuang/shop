...
<div>
        <div class="g-pay-lst">
            ...
            <p class="gray9">总需支付金额：<em class="orange"><i>￥</i>{{$money}}</em></p>
        </div>
        ...
        <div class="other_pay marginB">
            ...
            <a href="javascript:;" class="wzf checked">
            	<b class="z-sets"></b>支付<em class="orange fr"><span class="colorbbb">需要支付&nbsp;</span><b>￥</b>{{$money}}</em>
            </a>
            <div class="net-pay">
                <a href="javascript:;" class="checked " id="jdPay">
                	<span class="zfb"></span>
                	<b class="z-set" type="1"></b>
                </a>
                <a href="javascript:;"  id="jdPay">
                	<span class="kq"></span>
                	<b class="z-set" type="2"></b>
                </a>
            </div>
        ...
        <div class="paywrapp" style="display: none">
            ...
            <span class="money">￥<i>{{$money}}</i></span>
    ...
    $('#btnPay').click(function(){
        ...
        $('.z-set').each(function(){
            if($(this).parent().prop('class')!=''){
                type=$(this).attr('type');
               // console.log($(this).parent('a[class="checked"]'));
            }
        ...
        $('.z-set').click(function(){
          $('.z-set').parent().removeClass('checked')
